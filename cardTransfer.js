  ...
  function prepareCardExportPayload(meta, card, exportedAt, options) {
    ...
    if (opts.fillAllFields && schema && Array.isArray(schema.fields)) {
      ...
      schema.fields.forEach((field) => {
        const has = Object.prototype.hasOwnProperty.call(snapshot.data, field.id);
        filled[field.id] = has ? snapshot.data[field.id] : defaultBlankForField(field);
      });
      completeData = filled;
