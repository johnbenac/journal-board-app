      ...
      try {
        ...
        list.forEach((c) => {
          ...
          btn.addEventListener('click', () => {
            ...
            const idInput = form.querySelector('input[data-field-id="crmContactId"]');
            if (idInput) idInput.value = c.id;
            const urlInputEl = form.querySelector('input[data-field-id="crmContactUrl"]');
            if (urlInputEl) urlInputEl.value = cardData.crmContactUrl;
            updateRadarPreview();
            activityBody.innerHTML = '';
